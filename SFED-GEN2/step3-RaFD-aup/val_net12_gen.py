...
import val_net12_gen_DATA

def main():
    # 常量
    OUTPUT_DIR = './100-NET12-GEN/'
    MB = 25
    FOLD_FOR_VAL = 0
    ...
    [TRAIN_X, TRAIN_Y, TRAIN_Z, VAL_X, VAL_Y, VAL_Z] = val_net12_gen_DATA.load_cv(FOLD_FOR_VAL)
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session(config=sess_config) as sess:
            ...
            for itr in xrange(ITER_COUNT):
                ...
                val_x_val = VAL_Z[itr * MB:itr * MB + mb, :, :, :]  # 本程序中符号是 Z -> Z_HAT -> X_HAT
            ...
            for itr in xrange(ITER_COUNT):
                ...
                val_x_val = TRAIN_Z[itr * MB:itr * MB + mb, :, :, :]  # 本程序中符号是 Z -> Z_HAT -> X_HAT
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            for itr in xrange(ITER_COUNT):
                ...
                val_y_val = VAL_Y[itr * MB:itr * MB + mb, :]  # 表情生成
            ...
            for itr in xrange(ITER_COUNT):
                ...
                val_y_val = TRAIN_Y[itr * MB:itr * MB + mb, :]  # 表情生成
